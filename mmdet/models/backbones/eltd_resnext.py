...
from .eltd_resnet import Bottleneck as _Bottleneck
from .eltd_resnet import ELTD_ResNet
...
class ELTD_ResNeXt(ELTD_ResNet):
    ...
    def __init__(self, groups=1, base_width=4, **kwargs):
        ...
        super(ELTD_ResNeXt, self).__init__(**kwargs)
