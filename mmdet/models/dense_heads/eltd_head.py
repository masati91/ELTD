...
from .retina_head import ELTDRetinaHead
...
class ELTDHead(ELTDRetinaHead):

    def __init__(self, *args, score_threshold=None, **kwargs):
        super().__init__(*args, **kwargs)
        self.score_threshold = score_threshold
        self.kernel_method = kwargs['kernel_method']
        self.kernel_sigma = kwargs['kernel_sigma']
    ...
    def init_weights(self):
        ...
        super(ELTDHead, self).init_weights()
